...
/* */(function() {
const featureKey = "checkbox_label_click";// Replace this with your feature's  key (same as what's in features.json)
console.log("❤️"+"Checkbox Label Click");// Replace this with your feature's name
