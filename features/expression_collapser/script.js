...
(function () {
  console.log("❤️" + "Expression Collapser");
    ...
    mutations.forEach((mutation) => {
      mutation.addedNodes.forEach((node) => {
        ...
        if (node.nodeType === Node.ELEMENT_NODE) {
          ...
          if (
            node.matches(".long-text-composer-wrapper") ||
            node.matches(".expression-composer > div:first-child") ||
            node.matches(".expression-composer")
          ) {
